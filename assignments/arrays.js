...
// find out which car has an id of 33 by logging the car's year, make, and model in the console
// log provided to you below:
...
//  What is the make and model of the last car in the inventory?  Log the make and model 
// into the console.
...
// Create a new array from the dealer data containing only the car years and log the result 
// in the console.
let carYears = [];
for (let i = 0; i < inventory.length ; i++){
...
// Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array 
// in the console.
let BMWAndAudi = [];
for (let i = 0; i < inventory.length ; i++){
